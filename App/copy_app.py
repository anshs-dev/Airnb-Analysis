...
class airbnb:
    ...
    def dashboard(self):
        ...
        st.set_page_config(page_title='airBnB Project By Anshika', layout="wide")
        ...
        if selected =='Descriptive Statistics':
            ...
            with col1:
                ...
                st.markdown(
                    "<h1 style='font-size: 79px;'><span style='color:white;'>Howdy ,</span> <span style='color: white;'>I'm </span><span style='color: cyan;'> Anshika</span> </h1>",
            ...
            col2.markdown(
                    ...
                    unsafe_allow_html=True)
            keyboard_to_url(key="P", url="https://github.com/anshika4-dev")
            ...
            if selected_1 == 'CHOOSE OPTION':
                ...
                with col2:
                    ...
                    col2.markdown(
                        ...
                        unsafe_allow_html=True)
                    with col2:
                        keyboard_to_url(key="G", url="https://github.com/anshika4-dev")
